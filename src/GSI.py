...
def GSInterpolation(path_in, path_out, interval, tau):
    ...
    mkdir_if_missing(os.path.dirname(path_out))
    np.savetxt(path_out, gsi, fmt='%d,%d,%.2f,%.2f,%.2f,%.2f,%.2f,%d,%d,%d')

if __name__ == '__main__':
    import glob

    txt_path = 'E:/FairMOT/dataset/MOT17/images/results/IDK_fairmot'
    save_path = 'E:/FairMOT/dataset/MOT17/images/results/IDK_fairmot/results_GSI_ca'
