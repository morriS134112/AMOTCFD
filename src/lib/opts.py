...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            '--val_mot20', default=True, help='val mot20')
        self.parser.add_argument(
            '--test_mot20', default=False, help='test mot20')
        self.parser.add_argument(
            '--val_hie', default=False, help='val hie')
        self.parser.add_argument(
            '--test_hie', default=False, help='test hie')
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--match_thres', type=float, default=0.4, help='confidence thresh for match')
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--data_dir', type=str, default='E:/FairMOT/dataset')
